...
def main() -> None:
    ...
    p.add_argument("--model", required=True, help="model.zip / checkpoint .zip de SB3 (en /data)")
    ...
    out = Path(args.out) if args.out else model_path.parent / f"eval_{model_path.stem}.json"
