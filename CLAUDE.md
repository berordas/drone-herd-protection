...
`face_check.py` (12/12) · `battery_check.py` (4/2/2) · `escort_check.py` (8/8) · `drone_check.py`
...
3a movimiento de drones ✓ → 3b detectar→confirmar ✓ → **paso 2 guiado al refugio** → 3c corzos → **congelar v2** (Dummy, ~50% sin defensa) → reflejo-reactivo (consume el mensaje) → MARL.
*(Los coordinadores van DESPUÉS de congelar v2: v2 es la referencia que deben batir.)*
...
## Estado (commits)
`194a3ad` base · `37910b3` terminal · `e663504` disparador por dron · `4d1e708` campo 300 + escala absoluta · `886bd45` dispersión · `a15e2df` mov. drones (3a) · `fd893b8` detectar→confirmar (3b).
